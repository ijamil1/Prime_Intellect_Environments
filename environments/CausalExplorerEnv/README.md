...
- **Rubric overview**: Reward is fully concentrated on Blicket identification accuracy (weight 1.0). Exploration quality is not directly rewarded.
...
| --------- | ------ | ------- |
| `blicket_identification` | 1.0 | Per-object accuracy of Blicket predictions |
| `step_budget_utilization` | 0.0 | — |
| `exploration_efficiency` | 0.0 | — |
| `format_compliance` | 0.0 | — |
| `hypotheses_eliminated` | 0.0 | — |
