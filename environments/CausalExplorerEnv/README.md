...
- **Rubric overview**: Reward is fully concentrated on hypothesis elimination efficiency (weight 1.0), measuring how much of the hypothesis space the agent eliminates relative to a greedy info-gain agent. Final answer accuracy is not directly rewarded.
...
| --------- | ------ | ------- |
| `blicket_identification` | 0.0 | — |
| `step_budget_utilization` | 0.0 | — |
| `exploration_efficiency` | 0.0 | — |
| `format_compliance` | 0.0 | — |
| `hypotheses_eliminated` | 1.0 | Fraction of hypotheses eliminated vs. the optimal greedy info-gain agent. Higher is better |
